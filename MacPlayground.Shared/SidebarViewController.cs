...
namespace MacPlayground
{
	public class SidebarViewController : UIViewController, IUICollectionViewDelegate
    {
        ...
        public SidebarViewController(MacSidebarMenuOptions options)
        {
        ...
        public event EventHandler<SidebarMenuItemSelectedEventArgs>? OnMenuItemSelect;
        ...
        protected void ItemSelected(UICollectionView collectionView, NSIndexPath indexPath)
        {
            ...
            {
                this.OnMenuItemSelect?.Invoke(this, new SidebarMenuItemSelectedEventArgs(sidebarItem));
            }
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            this.NavigationItem.LargeTitleDisplayMode = this.options.LargeTitleDisplayMode;
